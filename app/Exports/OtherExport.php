...
class OtherExport implements FromArray
{
    /**
...
CREATE VIEW other AS
    SELECT 
        ...
        connections.connection as 'connections',
    ...
    INNER JOIN connections USING (id)
    LEFT JOIN o_b_a_s USING (id)
    INNER JOIN staff USING (id)
    
    WHERE applicants.submitted = 1 and applicants.section='Other Grades';
    */
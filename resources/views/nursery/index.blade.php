...
@section('content')
	<h2 class="text-center">Welcome to Nursery Admissions for {{$year}}</h2><br/>
	<p>Welcome to the Application Form for Student Admissions for the year {{$year}}. Please read and understand the following information before proceeding to purchase this application.</p>
	...
	<p>General Notes</p>
	<ul class="display_4">
		<li>This website is made available for parents to fill the Application Form online, to seek admission to the Nursery of S. Thomas' College, Mount Lavinia. However, filling this application form does not guarantee admission, and will be dependent on the application process.</li>
		<li style='color:red'><b>The Nursery is only for sons / daughters and grand sons / grand daughters of Old Boys and sons / daughters of members of the College Administrative / Tutorial staff. Please do not purchase an application form, if you don't meet this criteria.</b></li>
		...
		<i>Please note:-The form <b>CANNOT BE SUBMITTED AFTER</b> the closing date.</i></li>

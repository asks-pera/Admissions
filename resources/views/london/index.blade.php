...
@section('content')
	<h2 class="text-center">Welcome to International A/Level Admissions for {{$year}}</h2><br/>
	<p>Welcome to the Application Form for Student Admissions. This application form is only for those who will be sitting for the IGCSE (International Ordinary Level) Examination in May / June {{$year}}. Please read and understand the following information before proceeding to purchase this application.</p>
	...
	<p>General Notes</p>
	<ul class="display_4">
		<li>This application form CANNOT be used for admissions to any other grade. This is made avaialble only for students looking to be admitted for the International A/Levels from other schools.</li>
		<li>This website is made available for parents to fill the Application Form online. However, filling this application form does not guarantee admission, and will be dependent on the application process.</li>
		<li>Only after successful completion and submission of the application form, will the admissions process begin.</li>
		<li>You will be required to verify your email first by entering submitting a valid email address below. <b>This email address will be used for any and all further communication including the login credentials</b>. After which <b>you will be emailed the login credentials</b>, using which you can log in to the Application form at anytime to fill and finally submit same.</li>
		...
		<li>After the form is submitted, the information will be verified and short-listed. You will then receive an email from us indicating the next step in the process. Please await said email.</li>

...
@section('content')
	<h2 class="text-center">Welcome to A/Level Admissions for {{$year}}</h2><br/>
	<p>Welcome to the Application Form for Student Admissions. This application form is only for those who have already sat for the G.C.E. Ordinary Level Examination pending results. Please read and understand the following information before proceeding to purchase this application.</p>
	...
	<ul style="color:red">
		<li>'A' passes in at least 5 subjects at the O/Levels (Pre-O/Level Term Exam pending O/Level results)</li>
		<li>‘A’ passes in Maths and Science for Physical & Biological Sciences</li>
		<li>‘A’ passes in Maths and Business Studies for Commerce and Accounts</li>
	</ul><br/>
	<p>General Notes</p>
	<ul class="display_4">
		<li>This application form CANNOT be used for admissions to any other grade. This is made avaialble only for students who have completed the O/Levels and are looking to be admitted for the A/Levels.</li>

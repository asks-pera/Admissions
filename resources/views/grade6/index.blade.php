...
@section('content')
	<h2 class="text-center">Welcome to Grade 6 Admissions for {{$year}}</h2><br/>
	...
	<p>General Notes</p>
	<ul class="display_4">
		<li>This website is made available for parents to fill the Application Form online, to seek admission for your son(s) to Grade 6 in S. Thomas' College, Mount Lavinia. However, filling this application form does not guarantee admission, and will be dependent on the application process.</li>
		<li>Only after successful completion and submission of the application form, will the admissions process begin.</li>
		<li>Upon shortlising candidates based on the information given in the application form, the students will be invited to sit for an aptitude test in the school. We will consider the marks of the Grade 5 scholarship examinations as well as the school apptitude test and the interview to decide the admissions.</li>
		...
		<i>Please note:- If the form <b>CANNOT BE SUBMITTED AFTER</b> the closing date, the form will not be accepted.</i></li>
		...
		<li>During the time of purchasing, you will be required to enter an email address. Please use the personal email address of either the father or the mother of the child, as </li>
